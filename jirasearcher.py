...
def start_search(gov_number):
    ...
    jql = f'project = AMPP AND issuetype = "Запрос на обслуживание" AND status in (Закрыта, Выполнена) AND "Государственный номер" ~ "{gov_number}" ORDER BY created DESC'
